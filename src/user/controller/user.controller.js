...
export const createNewUser = async (req, res, next) => {
  ...
  try {
    ...
    if (user) {
      return next(
        new ErrorHandler(400, "email already registered")
      );
    }
...
export const forgetPassword = async (req, res, next) => {
  ...
  try {
    ...
    // Implement sendPasswordResetEmail function to send reset password email
...
export const resetUserPassword = async (req, res, next) => {
  ...
  try {
    ...
    // Save the user with the updated password and reset token
    await user.save();

    // In a real-world scenario, you might want to send a confirmation email to the user.
